...
function calculate() {
  ...
  let score = moy * 4 + 1 * document.getElementById("math").value;
  score += 1 * document.getElementById("phy").value;
  score +=
    1.5 *
    ((Number(document.getElementById("techTheo").value) * 3 +
      Number(document.getElementById("techPrat").value)) /
      4);
