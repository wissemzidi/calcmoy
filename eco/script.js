...
function calculate() {
  ...
  let score = moy * 4 + 1.5 * document.getElementById("eco").value;
  score += 1.5 * document.getElementById("gestion").value;
  score += 0.5 * document.getElementById("histoire").value;
  score += 0.5 * document.getElementById("math").value;
